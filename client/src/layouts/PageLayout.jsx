            ...
            currentUser ? (
              <div className="flex flex-col">
                ...
                <div
                  ...
                  id="navbar-default"
                >
                  <ul className="flex flex-col p-4 mt-4 border border-sky-100 rounded-lg bg-sky-60 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-sky dark:bg-sky-800 md:dark:bg-sky-900 dark:border-sky-700">
